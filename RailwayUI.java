...
public class RailwayUI extends JFrame implements ActionListener
{
JTextField seat, totalcost;
Choice type, block, source, destination, time; // Choices for the GUI
JLabel typelbl, blocklbl, sourcelbl, destinationlbl, timelbl, lblbl, mblbl, rblbl, inputseatlbl, totallbl, title;
...
output.write(newline);
output.write("Ticket Source: Mumbai");
output.write(newline);
output.write("Ticket Destination: Delhi");
output.write(newline);
